...
namespace IdentityNLayer.Areas.Identity.Pages.Account.Manage
{
    public partial class IndexModel : PageModel
    {
        ...
        private async Task LoadAsync(Person user)
        {
            ...
            Input = new InputModel
            {
                ...
                BirthDate = user.BirthDate != null ? (DateTime)user.BirthDate : new DateTime()
            };
        }
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            if(Input.BirthDate != (await _userManager.GetUserAsync(User)).BirthDate)
            {
